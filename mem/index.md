...
Every color in every spec MUST be listed in 4 formats: oklch + hex + rgb + hsl. Section by section, part by part. See `prompts/08-color-format-rule.md`.
Project-wide default text-shadow: `--shadow-text-default: rgb(0 0 0) 1px 0.7px 0px;` — apply to headline/body text on dark surfaces. See `prompts/07-text-shadow.md`.
...
- Color & text-shadow rules live in `prompts/06-color-and-typography.md`, `prompts/07-text-shadow.md`, `prompts/08-color-format-rule.md` (not mirrored in `mem/`).
