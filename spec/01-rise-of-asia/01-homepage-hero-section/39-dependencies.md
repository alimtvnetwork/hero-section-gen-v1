...
**Authority:** Promotes the allowlist from `34-supply-chain.md` into a stand-alone, versioned document with an RFC template for additions.

## Current allowlist (hero scope, runtime)

See `34-supply-chain.md` §Allowlist (canonical table). This file owns the **process**.

## Current denylist

See `34-supply-chain.md` §Denylist.
