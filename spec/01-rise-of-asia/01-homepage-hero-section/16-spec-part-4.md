...
**What:** A one-page `spec/01-rise-of-asia/01-homepage-hero-section/VOICE.md` covering:
...
**What:** `spec/01-rise-of-asia/01-homepage-hero-section/README.md` (≤1 screen) covering:
...
45. **Changelog & versioning policy** — semver for the `<Hero/>` component (when does a copy tweak vs. a prop signature change bump major?), `21-changelog.md` format, release notes template.
