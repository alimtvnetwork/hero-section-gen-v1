...
Continuation of `13-spec.md`. Each item includes **Reasoning** (why it matters) and **Time** (realistic estimate for a mid-level dev using the Part 1 stack). Times assume Part 1 tokens, fonts, and DOM skeleton already exist.
