...
Continuation of `13-spec.md` and `14-spec-part-2.md`. Same **What / Reasoning / Time** format. Times assume Parts 1–2 are implemented.
...
43. **Onboarding for new contributors** — `spec/01-rise-of-asia/01-homepage-hero-section/README.md` that points to all three SPEC files, the Figma source, and the component story.
