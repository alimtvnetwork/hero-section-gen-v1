...
| Spec files | `NN-kebab-case.md` (numeric prefix sortable) | `02-spec-canvas.md` | `14-spec-part-2.md` *(grandfathered)* |
...
3. **Grandfathered files** (`13-spec.md`, `SPEC-PART-N.md`) keep current names until the spec-file rename pass (post-MVP) to avoid breaking inbound links.
