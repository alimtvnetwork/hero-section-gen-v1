...
**Authority:** This file is the only source for color/space/motion/type values. `src/styles.css` must mirror this file verbatim. Any token defined in SPEC.md §2 or PART-5 §57 is **derived** from here and treated as documentation.
...
`TOKENS.md` is the source. PART-5 §57 (Style Dictionary export) consumes this file and emits:
