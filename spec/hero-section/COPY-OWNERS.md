...
| `hero.error.body` | (see STATES.md canonical) | @copy | @copy | — |
...
2. CODEOWNERS auto-requests the listed owner(s).
...
5. After merge, copy lives in CMS — production rollout follows `CMS-PREVIEW.md` rollback rules.
