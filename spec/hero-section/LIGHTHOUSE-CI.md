...
**Owner:** Performance · **Closes:** #57 (graduates BUDGETS.md from 🟡 → ✅)
...
## CI job
`lhci autorun` in workflow (see `CI.md`). Median of 5 runs used for assertions. Reports retained 30d.

## Failure → action
Block merge. PR comment posts diff vs `main` baseline. Owner triages within 1 business day; regression budget in `BUDGETS.md`.
