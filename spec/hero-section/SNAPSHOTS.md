...
Plus state snapshots per `STATES.md`: `HeroLoading`, `HeroEmpty`, `HeroError`, `HeroOffline` at 1440 + 375.

Plus fixture snapshots per `EDGE-CASES.md`: EC-01..EC-20 at 1440 + 375 minimum.
...
4. Each baseline regen requires a `@design` CODEOWNERS approval (per `CODEOWNERS`, Batch 5).
