...
**Authority:** Aligns with `HEAD-META.md`. Owns environment-conditional rules.
...
- Per leaf route only (see `HEAD-META.md` and TanStack canonical-dedupe caveat).
...
- LCP portrait doubles as OG image (see `HEAD-META.md`).
- Dimensions 1200×630 minimum; JPEG; ≤ 200 KB.
- Cached at CDN `og/<route>-vN.jpg` per `CDN.md`.
